           ...
           <div id="navigation">
              <ul id="menu">
                 <li><a href="http://beta.drdoormat.com/about.html">about</a></li>
                  ...
                  <li><a href="http://beta.drdoormat.com/choose-mat.html">Choose your mat</a></li>
      ...
      <div class="inner story" >
        ...
        <div id="contact-form">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" id="contact" method="post" accept-charset="utf-8">
            ...
            <input type="text" id="name" name="name" class="txt" style="width: 400px;"/>
            <br />
    ...
    <div id="footer">
      <div class="inner">
        ...
        <ul id="second-footer-links">
          <li><a href="#">Shipping &amp; Return Info</a></li>
