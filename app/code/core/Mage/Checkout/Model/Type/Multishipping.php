...
require_once(dirname(__FILE__) . '/../../../../../../../lib/cim/cimutils.php');
...
class Mage_Checkout_Model_Type_Multishipping extends Mage_Checkout_Model_Type_Abstract
{
    ...
    public function createOrders()
    {
        ...
        $address_data = $this->getQuote()->getBillingAddress()->getData();
        $payment_data = Mage::getModel('sales/convert_quote')->paymentToOrderPayment($this->getQuote()->getPayment())->getData();
        ...
        foreach ($orders as $order) {
            $order->place();
            $order->save();
            AuthnetCIMHelper::magentoCreateOrUpdateForOrder($order->getEntityId(), $payment_data, $address_data);
