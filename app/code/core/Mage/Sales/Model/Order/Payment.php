...
class Mage_Sales_Model_Order_Payment extends Mage_Payment_Model_Info
{
            ...
            if ($methodInstance->isInitializeNeeded()) {
                ...
                switch ($action) {
                    ...
                    case Mage_Payment_Model_Method_Abstract::ACTION_AUTHORIZE_CAPTURE:
                        ...
                        $__invoice = $this->getCreatedInvoice();
                        if(!empty($__invoice)) {
                          $doormat_amount_to_capture = $__invoice->getDoormatAmountToCapture();
                          $this->setAmountOrdered($doormat_amount_to_capture);
                          $this->setBaseAmountOrdered($doormat_amount_to_capture);
                          $this->setAmountAuthorized($doormat_amount_to_capture);
                          $this->setBaseAmountAuthorized($doormat_amount_to_capture);
                        }
                        break;
                    default:
                        break;
    ...
    public function capture($invoice)
    {
        ...
        $amountToCapture = $this->_formatAmount($invoice->getDoormatAmountToCapture());
        $order = $this->getOrder();
